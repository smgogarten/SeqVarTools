...
For binary phenotypes, there are two options, "logistic" and "firth". "logistic" uses `glm` and performs a Wald test. "firth" uses `logistf`. We recommend using the Firth test for rare variants ([Wang 2014](https://pubmed.ncbi.nlm.nih.gov/24995013/))]
